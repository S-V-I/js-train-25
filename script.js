...
// Створюємо асинхронну функцію getData,
// яка використовує await для обробки Promise.
...
//Завдання 2
// Функція getRandomNumberAfterSeconds,
...
function getRandomNumberAfterSeconds(seconds) {
  ...
  return new Promise((resolve) => {
    ...
    // Після "seconds" секунд, Promise буде виконано з результатом
    // виконання функціх Math.random
    setTimeout(() => {
      resolve(Math.random());
    }, seconds * 1000);
  });
...
// яка приймає один параметр - число секунд
// Використовуємо try для обробки помилок
// Використовуємо await, щоб "почекати", поки Promise
// від getRandomNumberAfterSeconds буде виконано.
...
// якщо ні виводимо помилку в консоль
...
//Завдання 4
// Асинхронна функція, яка приймає три параметри - URL, дані для відправки
// та токен авторизації, маємо аргумент url, data, authToken
// Використовуємо try для обробки помилок
...
// і буде збільшуватися на 1 при кожній ітерації.
// Цикл "while (true)" - це безкінечний цикл, який продовжуватиме
// виконуватися, поки його не зупинять зовні.
// Чекаємо поки виконається проміс якому встановимо затримку 1 секунду
// за допомогою setTimeout
// Віддаємо значення лічильника та збільшуємо його на один

// Використовуємо асинхронний генератор
// та записуємо його значення в константу gen
...
// Умова "if (value === 4) break" зупиняє цикл після виведення
// п'яти чисел (від 0 до 4).
...
//Завдання 7
// Створюємо генератор countdownGenerator, який створює послідовність чисел
// від вказаного значення до 0, має параметр start
...
// яку записуємо в змінну nextValue
// Цикл while, що виводить значення з генератора,
// та працює поки не є генератор вичерпаним.
